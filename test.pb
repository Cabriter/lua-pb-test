...
yield_rate (:0R	yieldRate
dialogid (:0Rdialogid
	wait_time (:0RwaitTime&
rewards (2.test.rewardRrewards"Œ
collecting_region
	region_id (:0RregionId
status (:0Rstatus
	last_time (:0RlastTime
staff_id (:0RstaffId"E
collecting_staff
id (:0Rid
	last_time (:0RlastTime"Ý
	chat_info=

food_guide (2.test.chat_info.FoodGuideEntryR	foodGuideO
ingredient_guide (2$.test.chat_info.IngredientGuideEntryRingredientGuideI
employee_guide (2".test.chat_info.EmployeeGuideEntryRemployeeGuideM
FoodGuideEntry
key (Rkey%
value (2.test.unit_chatRvalue:8S
IngredientGuideEntry
key (Rkey%
value (2.test.unit_chatRvalue:8Q
EmployeeGuideEntry
key (Rkey%
value (2.test.unit_chatRvalue:8"8
	unit_chat+
contents (2.test.user_chatRcontents"J
	user_chat#
user (2.test.user_infoRuser
content (	Rcontent"F
	user_info
id (:0Rid
name (	Rname
